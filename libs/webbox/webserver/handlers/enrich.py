...
class EnrichHandler(BaseHandler):
    ...
    def save_round(self, request):
	    ...
	    self.save_entity_from_round(r["place-abbrv"], r["place-full"], "places", request)
        
        if not (r["establishment-full"] == "_NOT_SPECIFIED_" or r["establishment-abbrv"] == "_NOT_SPECIFIED_"):
	    self.save_entity_from_round(r["establishment-abbrv"], r["establishment-full"], "establishments", request)      
