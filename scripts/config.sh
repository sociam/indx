...
export LOG_RWW="~/.webbox/data/logs/rww.log"
export LOG_SECURESTORE="~/.webbox/data/logs/webbox_server.log"
export LOG_4S="~/.webbox/data/logs/4store.log"
export PORT="8212"
export RWW_LD="~/.webbox/data/rww"
