...
class TwitterApp(BaseHandler):
    ...
    def set_config(self, request): # what params?
        try:
            ...
            logging.debug("service_twitter config {0}".format(config))
...
TwitterApp.subhandlers = [
    {
        "prefix": "service_twitter/api/set_config",
        'methods': ['GET'],
        'require_auth': True,
        'require_token': False,
        'handler': TwitterApp.set_config,
        'accept':['application/json'],
        'content-type':'application/json'
    },
    {
        "prefix": "service_twitter/api/get_config",
        'methods': ['GET'],
        'require_auth': True,
        'require_token': False,
        'handler': TwitterApp.get_config,
        'accept':['application/json'],
        'content-type':'application/json'
    },    
    {
        "prefix": "service_twitter/api/start",
        'methods': ['GET'],
        'require_auth': True,
        'require_token': False,
        'handler': TwitterApp.start_handler,
        'accept':['application/json'],
        'content-type':'application/json'
    },
    {
        "prefix": "service_twitter/api/stop",
        'methods': ['GET'],
        'require_auth': True,
        'require_token': False,
        'handler': TwitterApp.stop_handler,
        'accept':['application/json'],
        'content-type':'application/json'
    },
    {
        "prefix": "service_twitter/api/is_running",
        'methods': ['GET'],
        'require_auth': True,
        'require_token': False,
        'handler': TwitterApp.is_running_handler,
        'accept':['application/json'],
        'content-type':'application/json'
    }
